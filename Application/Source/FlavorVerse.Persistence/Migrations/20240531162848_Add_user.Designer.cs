...
namespace FlavorVerse.Persistence.Migrations
{
    ...
    [Migration("20240531162848_Add_user")]
            ...
            modelBuilder.Entity("FlavorVerse.Domain.Entities.Application.Nutrition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Calories = 400,
                            Carbohydrates = 45,
                            CreatedAt = new DateTime(2024, 5, 31, 16, 28, 47, 327, DateTimeKind.Utc).AddTicks(1656),
                            Fat = 20,
                            Fiber = 2,
                            IsActive = true,
                            Protein = 15
                        ...
                        new
                        {
                            ...
                            Calories = 150,
                            Carbohydrates = 10,
                            CreatedAt = new DateTime(2024, 5, 31, 16, 28, 47, 327, DateTimeKind.Utc).AddTicks(1662),
                            Fat = 12,
                            Fiber = 3,
                            IsActive = true,
                            Protein = 4
            ...
            modelBuilder.Entity("FlavorVerse.Domain.Entities.Application.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 5, 31, 16, 28, 47, 329, DateTimeKind.Utc).AddTicks(6993),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 5, 31, 16, 28, 47, 329, DateTimeKind.Utc).AddTicks(6999),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 5, 31, 16, 28, 47, 329, DateTimeKind.Utc).AddTicks(7014),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 5, 31, 16, 28, 47, 329, DateTimeKind.Utc).AddTicks(7019),
                        ...
                        new
                        {
                            ...
                            CookingTime = "20 minutes",
                            CreatedAt = new DateTime(2024, 5, 31, 16, 28, 47, 329, DateTimeKind.Utc).AddTicks(7023),
            ...
            modelBuilder.Entity("FlavorVerse.Domain.Entities.Application.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 5, 31, 16, 28, 47, 446, DateTimeKind.Utc).AddTicks(1198),
                            ...
                            Password = "$2a$11$/TlmEnj5.1rGXFDeyoYHZuBvgMpR5nc5jC4wEghNCH7fBFENfluUa",
                            Phone = "0000000000"
                        },
                        new
                        {
                            Id = new Guid("99e3dc0d-b4ec-4a00-a7fc-208fc3ce6d08"),
                            CreatedAt = new DateTime(2024, 5, 31, 16, 28, 47, 561, DateTimeKind.Utc).AddTicks(7355),
                            ...
                            IsActive = false,
                            LastName = "Nemanjić",
                            Password = "$2a$11$x5toyZk4PREyC1MQdKMOrO9Z4c0SV2i/ioeYWMcpS8Rxs8Q8UmIWW",
                            Phone = "0661261261"
                        },
                        new
                        {
                            Id = new Guid("5642960e-c7c6-40bf-a8d8-7d7457dc1212"),
                            CreatedAt = new DateTime(2024, 5, 31, 16, 28, 47, 671, DateTimeKind.Utc).AddTicks(8412),
                            ...
                            IsActive = false,
                            LastName = "Obradović",
                            Password = "$2a$11$MnQ3wSZQSSkMIJETRcRghOG/adOrbB1yOc8GSFYG02IOPibv.4M4y",
                            Phone = "0646464646"
                        },
                        new
                        {
                            Id = new Guid("030c3159-d298-41d5-9ba4-b65fe274cbae"),
                            CreatedAt = new DateTime(2024, 5, 31, 16, 28, 47, 779, DateTimeKind.Utc).AddTicks(9028),
                            DateOfBirth = new DateOnly(2002, 10, 10),
                            DisplayName = "",
                            ...
                            IsActive = false,
                            LastName = "Pualić-Radujko",
                            Password = "$2a$11$vD3lI4PY/LXhAANTgkaROeu0GCRLrNEutG8IVpdu700FT9cZUYSii",
                            Phone = "0612323232"
                        });
                });
