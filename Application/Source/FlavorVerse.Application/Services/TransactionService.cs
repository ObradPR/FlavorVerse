...
namespace FlavorVerse.Application.Services
{
    public sealed class TransactionService : ITransactionService
    {
        ...
        public async Task<Result<TValue>> TryProcess<TEntityId, TValue>(
            Guid transactionId,
            TEntityId entityId,
            eEntityType entityTypeId,
            eActionType actionTypeId,
            Guid executedById,
            ...
            where TEntityId : struct
        {
            ...
            finally
            {
                ...
                {
                    audit.Id = Guid.NewGuid();
                    audit.EntityId = entityId.ToString() ?? string.Empty;
                    audit.EntityTypeId = (int)entityTypeId;
                    audit.ActionTypeId = (int)actionTypeId;
                    audit.RecordDate = DateTime.UtcNow;
                    audit.ExecutedById = executedById;
